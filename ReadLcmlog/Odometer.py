...
class vehicle_status_t(object):
    __slots__ = ["utime", "nauto", "steerPos", "steerSpe", "light", "speLeft", "speRight", "vot", "shift", "disLeft", "disRight", "speo", "yawRate", "accelerationLon", "accelerationLat"]
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">qifiifffiffffff", self.utime, self.nauto, self.steerPos, self.steerSpe, self.light, self.speLeft, self.speRight, self.vot, self.shift, self.disLeft, self.disRight, self.speo, self.yawRate, self.accelerationLon, self.accelerationLat))
    ...
    def _decode_one(buf):
        ...
        self.utime, self.nauto, self.steerPos, self.steerSpe, self.light, self.speLeft, self.speRight, self.vot, self.shift, self.disLeft, self.disRight, self.speo, self.yawRate, self.accelerationLon, self.accelerationLat = struct.unpack(">qifiifffiffffff", buf.read(64))
        return self
    ...
    def speed(event, data):
        ...
        if auto == 1:
            ...
            if b == 0 :
                ...
                file.write('{}  自动驾驶里程 {:.2f} m\n'.format(time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()) ,float(sum(square))))
                file.close()
                b = 1
                square.clear()
